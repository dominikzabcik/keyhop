...
- Ranked seasons. Every calendar month is a season, and the tokens you use in it place you on a ladder of six tiers, from Bronze to Master, each with three divisions. The season page shows the standings, what the next division costs and how many days are left, and finished seasons stay readable. Your tier also shows on your profile and in Switchr's Leaderboard section.
