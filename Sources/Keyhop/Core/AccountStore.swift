...
final class AccountStore: ObservableObject {
    ...
    /// 0...1 while the menu bar icon animates to show where Keyhop lives.
    ...
    init() {
        ...
        // The menu or Keyhop's window just came forward; reads at most every 90 seconds.
    ...
    /// Picks up what Keyhop's window changed. It shares this store's AccountService, so accounts
    ...
    /// Keeps `keyhop status` in Terminal in step with the menu, without another round of requests.
