...
/// running keyhop.exe, and `--show-menu` or `--show-dialog` open them for screenshots.
...
TrayApp.shared.run()
#else
print("KeyhopTray is the Windows tray app. On Linux run keyhop-tray; on macOS Keyhop lives in the menu bar.")
#endif
