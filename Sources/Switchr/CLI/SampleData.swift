...
/// Made-up accounts and usage for screenshots, docs and CI: `switchr status --sample` and
/// `switchr insights --sample`. Touches no files, secret stores or network, and never contains a
/// real login.
enum SampleData {
