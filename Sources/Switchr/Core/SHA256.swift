...
/// SHA-256 (FIPS 180-4) for systems without CryptoKit, so verifying a download never depends on
/// an outside tool. Checked against CryptoKit and published test vectors in the tests.
enum SHA256Digest {
