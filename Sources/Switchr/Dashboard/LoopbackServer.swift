...
final class LoopbackServer: @unchecked Sendable {
    ...
    init(port requested: UInt16 = 0) throws {
        ...
        guard Sockets.isValid(listener) else { throw SwitchrError("Couldn't open a local socket for the dashboard.") }
        ...
        guard bound, Sockets.listen(listener) else {
            ...
            throw SwitchrError("Couldn't start the dashboard on this computer.")
        }
