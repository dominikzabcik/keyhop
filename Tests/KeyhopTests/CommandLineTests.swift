...
/// The Linux and Windows trays read these fields from `keyhop status --json`.
...
final class StorageTests: XCTestCase {
    func testFileSecretsAreReadableOnlyByTheUser() throws {
        ...
        #else
        let directory = FileManager.default.temporaryDirectory.appendingPathComponent("keyhop-secrets-\(UUID().uuidString)")
