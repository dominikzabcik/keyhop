...
export function downloadPage(): Html {
  return html`<div class="marketing-page">
    ...
    <section class="content-split">
      ...
      <div class="prose"><p>Open Keyhop and it finds the Claude Code, Cursor and Codex logins already on your computer. Add another account by signing in to the tool normally when Keyhop asks.</p><p>No provider API key is required. Codex accounts must use a ChatGPT sign-in; API-key-only Codex logins are not supported.</p></div>
    </section>
