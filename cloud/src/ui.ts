...
/* Copilot and Windsurf carry no counted usage, so these only matter if that ever changes. */
.mix .copilot, .swatch.copilot { background: hsl(0 0% 100% / .09); }
.mix .windsurf, .swatch.windsurf { background: hsl(0 0% 100% / .05); }
...
export function layout(options: {
  ...
  const description = options.description ?? "Keyhop leaderboards: who uses the most Claude Code, Cursor, Codex and Gemini CLI.";
